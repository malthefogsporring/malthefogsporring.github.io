...
∞-operads are gadgets for encoding homotopy-coherent algebraic structures. By a variant of the envelope functor, one can identify ∞-operads with certain symmetric monoidal categories equipped with a monoidal functor to FinSet. In the 1-categorical setting, this goes back to work of Adams and Kelly; in the ∞-categorical setting, it is due to Haugseng-Kock. I will describe the proof of this result and discuss some philosophical implications.</details></li>
